...
import kotlinx.android.synthetic.main.fragment_my_travels_tab.view.*

class MyTravelsTab : Fragment() {
    ...
    override fun onCreateView(
        ...
        _view = inflater.inflate(R.layout.fragment_my_travels_tab, container, false)
    ...
    private fun getChats(){
        chatsDb.whereEqualTo("receiver", currentuser.uid)
